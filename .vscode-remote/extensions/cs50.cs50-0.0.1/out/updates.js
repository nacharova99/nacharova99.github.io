...
exports.detectInsiderVersion = exports.checkCS50TokenExpiry = exports.checkForUpdates = void 0;
...
function checkCS50TokenExpiry() {
    try {
        ...
        axios.get(url, { headers: headers }).then((response) => {
            const cs50Token = response.data['secrets'].filter((secret) => {
...
exports.checkCS50TokenExpiry = checkCS50TokenExpiry;
function promptRelogin() {
    const message = 'Please visit https://cs50.dev and log in again.';
    vscode.window.showErrorMessage(message, ...['OK']).then(() => {
